...
//     Error {
//         description: String,
//         cause: Option<Box<dyn StandardError>>,
//     },
...
//         }
//     }
//     pub fn with_cause(description: &str, cause: Box<dyn StandardError>) -> Error {
//         Error::Error {
//             description: String::from(description),
//             cause: Some(cause),
//         }
...
//         match self {
//             Error::Error { description, cause } => write!(f, "Error: {}", description),
...
// }
// 
// impl From<dyn StandardError> for Error {
//     fn from(cause: dyn StandardError) -> Self {
//         Error::new(&"Error: ".to_string() + cause.description())
//     }
// }
// 
